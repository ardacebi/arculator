...
g++ -o arculator main.out angle.out area.out data.out energy.out length.out power.out pressure.out speed.out temperature.out time.out volume.out weight.out
rm main.out angle.out area.out data.out energy.out length.out power.out pressure.out speed.out temperature.out time.out volume.out weight.out
